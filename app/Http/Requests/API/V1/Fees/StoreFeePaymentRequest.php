...
final class StoreFeePaymentRequest extends FormRequest
{
    ...
    {
        return [
            'fee_invoice_id.required' => 'Fee invoice is required',
            'fee_invoice_id.exists' => 'Selected fee invoice does not exist',
